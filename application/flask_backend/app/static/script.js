...
var weather_changer = document.querySelector(".weather-changer")
var weather_from_backend = document.querySelector(".current_weather").textContent
// Set mask for leaf holder 
...
{
	summary.html(weather_from_backend);
...
var b = document.querySelector("#button-rain")
b.click()


Toastify({
	text: "You are looking at the current weather details !!!",
	duration: 5000,
	newWindow: true,
	close: true,
...
if (weather_from_backend === " rain"){
	document.querySelector("#button-rain").click()
  }
else if (weather_from_backend == "few clouds"){
	document.querySelector("#button-wind").click()	
}
else if (weather_from_backend == " scattered clouds" && !isDayTime){
	document.querySelector("#button-wind").click()
}
else if (weather_from_backend == "mist"){
	document.querySelector("#button-snow").click()	
}
else if (weather_from_backend == "clear sky" && isDayTime) {
	document.querySelector("#button-sun").click()	
}
